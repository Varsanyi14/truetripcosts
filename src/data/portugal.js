export default {
  ...
  trio: [
    ...
    { sym: "atm", kind: "ok", h: "ATMs", verd: "Use a Multibanco, not Euronet", p: "Look for the <b>Multibanco</b> (MB) network, the national bank machines, which charge little or nothing for the withdrawal itself (CGD, Millennium, Novo Banco, Caixa Geral). Avoid the bright yellow standalone <b>Euronet</b> machines at airports and tourist squares, which charge 5 to 7 euros and push the dollar conversion. It may ask about conversion twice, so decline both times.", cta: { label: "See low-fee cards", href: "#" } }
  ],
  plan: [
