  ...
  spokes: [
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in France: service compris, and how much",
      description: "Service is already included by law in France, the service compris. Whether to leave a pourboire at all, and how much when you do. Checked 2026.",
    ...
    },
    {
      ...
      topic: "taxis",
      caution: "low",
      title: "Paris taxis and Uber, and the CDG fixed fare 2026",
      description: "Uber and Bolt run in Paris alongside G7 and FreeNow. The government-fixed CDG and Orly fares, the unlicensed touts to skip, and when the RER B wins.",
    ...
    },
    {
      ...
      topic: "pets",
      insurance: true,
      title: "Bringing a dog or cat to France from the US 2026",
      description: "France runs on the shared EU health-certificate process, with no quarantine and no titer. What is France-specific on arrival and after you settle in.",
    ...
    },
    {
      ...
      live: true,
      topic: "tourist-tax",
      title: "France tourist tax (taxe de sejour) 2026: Paris",
      description: "France adds a per-adult, per-night tax at your accommodation, not in the online price. Why Paris surcharges push it to the mid-teens, and who is exempt.",
    ...
    },
    {
      ...
      live: true,
      topic: "cash",
      title: "Do I need cash in France? Cards vs euros 2026",
      description: "France is card-first, so tap almost everywhere and keep a chip-and-PIN card for unmanned machines. Card minimums, Euronet kiosks, and choosing euros.",
    ...
    },
    {
      ...
      topic: "driving",
      carExcess: true,
      title: "Renting a car in France: tolls, Crit'Air, excess",
      description: "Autoroute tolls add up, and a long drive can top 50 to 90 euros. Low-emission zones need a Crit'Air sticker, and your US card usually will not cover you.",
    ...
    },
    {
      ...
      topic: "scams",
      caution: "medium",
      title: "Common money scams in France, and what they cost",
      description: "Unofficial drivers at the airport, the gold-ring and bracelet setups, Metro ticket-machine helpers, and the dollar-conversion push. Checked 2026.",
