  ...
  spokes: [
    {
      ...
      topic: "taxis",
      caution: "medium",
      title: "Taxis in Brazil: use Uber or 99, and stay safe",
      description: "Uber and 99 are the safer and cheaper way around Brazil. How to leave the airport safely, and the street-taxi habits worth avoiding. Checked 2026.",
    ...
    },
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in Brazil: the 10% servico, explained",
      description: "A 10% service charge, the servico, is usually printed on the bill and is technically optional. What to do for taxis and small services. Checked 2026.",
    ...
    },
    {
      ...
      live: true,
      topic: "visas",
      title: "Do US citizens need a visa for Brazil? Yes, e-visa",
      description: "Since April 2025 US citizens need a Brazil e-visa, applied for online before you fly. The official portal, the US$80.90 fee, and how long it lasts.",
    ...
    },
    {
      ...
      live: true,
      topic: "cash",
      title: "Do I need cash in Brazil? Cards, Pix and the IOF",
      description: "Cards work almost everywhere in Brazilian cities, so you need little cash. Two catches: Pix is mostly closed to tourists, and foreign cards pay the IOF.",
