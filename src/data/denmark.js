export default {
  ...
  spokes: [
    ...
    },
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in Denmark: you do not really tip 2026",
      description: "Danish wages are high and service is included, so tipping is not really expected. When to round up, and how to handle the card terminal prompt.",
    ...
    },
    {
      ...
      live: true,
      topic: "cash",
      title: "Do I need cash in Denmark? Almost never 2026",
      description: "Denmark is nearly cashless and contactless is everywhere, with some places taking little cash. The currency is the krone, so choose krone, not dollars.",
    ...
    },
    {
      ...
      topic: "pets",
      insurance: true,
      title: "Bringing a dog or cat to Denmark from the US 2026",
      description: "Denmark runs on the shared EU health-certificate process, with no quarantine and no titer. What is Denmark-specific on arrival and after you settle in.",
