...
export default {
  ...
  sources: {
    ...
    links: [
      ...
      { label: "New Zealand: the surcharge ban bill, whose May 2026 deadline passed without legislation after a coalition partner withdrew support, so card surcharges still apply", url: "https://www.rnz.co.nz/news/business/597751/card-payment-surcharge-ban-to-go-ahead-finance-minister-says", type: "news" },
  ...
  keyFacts: [
    ...
    { label: "Card surcharge ban", value: "A ban on in-store card surcharges was promised for May 2026, but the bill stalled without the coalition support to pass it, so surcharges still apply and there is no date to plan around", status: "proposed", effective: null, source: "https://www.rnz.co.nz/news/business/597751/card-payment-surcharge-ban-to-go-ahead-finance-minister-says", checked: "2026-09-01" }
  ],
  ...
  spokes: [
    {
      ...
      topic: "taxis",
      caution: "low",
      title: "Taxis in New Zealand: apps, and cashless cabs",
      description: "Uber and its rivals cover New Zealand. Cabs are metered and cashless with a card surcharge, airports have no train, and tipping is not expected.",
    ...
    },
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in New Zealand: you do not need to tip",
      description: "Tipping is not expected in New Zealand because staff earn a high minimum wage. When a small tip is optional, and how to handle the terminal prompt.",
    ...
    },
    {
      ...
      live: true,
      topic: "visas",
      title: "New Zealand NZeTA and IVL: two fees, not one",
      description: "US citizens need an NZeTA at NZ$17 by app plus the NZ$100 tourism levy, paid together before you fly. The official app, and the real total. Checked 2026.",
    ...
    },
    {
      ...
      live: true,
      topic: "cash",
      title: "Do I need cash in New Zealand? Almost never",
      description: "New Zealand is nearly cashless, so tap almost everywhere. The local quirk is card surcharges of 1.5 to 2%, still legal after a promised ban stalled.",
    ...
    },
    {
      ...
      live: true,
      topic: "pets",
      title: "Bringing a dog or cat to New Zealand: 6 to 7 months",
      description: "A strict 6 to 7 month process: blood titer, Brucella testing for dogs, and at least 10 days of quarantine. Plus the 2026 import-standard change to check.",
      ...
      sections: [
        ...
        },
        {
          ...
          p: [
            ...
            `Roaming is about <b>${S.dayPass}</b> on <b>AT&amp;T or Verizon</b>, though <b>AT&amp;T caps its Day Pass at ${S.capFees}</b>, about <b>${S.capAmount}</b>, while <b>Verizon's TravelPass has ${S.verizonNoCap}</b> and keeps billing daily, which matters on the three-week trips New Zealand tends to produce. <b>T-Mobile</b>'s current tiers include roughly <b>${S.tmoLow}</b> on Experience More, Magenta MAX and Go5G Plus, <b>${S.tmoMid}</b> on Experience Beyond and Go5G Next and <b>${S.tmoHigh}</b> on Better Value, slowing to <b>${S.throttle}</b> after that, and given the satellite point above, a T-Mobile customer should look at their own plan before buying anything here. This guide is written for US travelers departing the US. For more, see <a href='/new-zealand/cash-or-card'>cash or card in New Zealand</a>, <a href='/new-zealand/taxis-and-apps'>taxis and apps in New Zealand</a>, and the <a href='/new-zealand'>New Zealand money guide</a>.`
          ]
        }
      ],
      faqs: [
