      ...
      sections: [
        {
          ...
          p: [
            ...
            `Who does still pay? Anyone <b>not</b> on a current unlimited plan. Older, basic and some prepaid plans exclude Canada, and then the options are an add-on such as AT&amp;T's <b>Roam North America</b>, or a day pass at around <b>${S.dayPass}</b>, which is the same order as Europe rather than the bargain it is sometimes called. The thing to avoid outright is roaming with <b>no plan at all</b>: pay-per-use runs about <b>${S.ppu}</b>, thousands of dollars a gigabyte, and a phone burns data in the background with the screen off. If you are unsure, <b>turn off data roaming</b> until you have checked. One border quirk worth knowing: around <b>Windsor and Detroit</b>, Canadian towers reach across, so your phone can register on a Canadian network while you are still in the US. It should not be billed, but check the statement if you were near a crossing.`
          ]
        },
        {
