export default {
  ...
  trio: [
    ...
    { sym: "atm", kind: "ok", h: "ATMs (cashpoints)", verd: "Use a free LINK one, not Euronet", p: "Most of the UK's roughly 70,000 cashpoints are <b>free to use</b> through the LINK network, including bank machines, with an on-screen <b>free withdrawal</b> note. Avoid <b>fee-charging</b> machines in some convenience stores and nightlife spots (about 1.75 to 3.95 pounds, shown on screen first) and the standalone <b>Euronet</b> ones that push dollar conversion. If a screen offers dollars, choose pounds.", cta: { label: "See low-fee cards", href: "#" } }
  ],
  plan: [
  ...
  facts: [
    ...
    { sym: "tip", k: "Tipping is light", v: "Britain is not a US-style tipping culture. Staff earn at least the legal minimum wage, about 12.21 pounds an hour, so tips are a bonus rather than a top-up. Many restaurants add a <b>discretionary 12.5% service charge</b>, and if it is on the bill, that is the tip. No tipping for drinks at a pub bar." }
  ],
  taxfree: {
