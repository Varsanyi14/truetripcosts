  ...
  spokes: [
    ...
    },
    {
      ...
      faqs: [
        ...
        { q: "How much does it cost to use my US phone in the UK?", a: "About 10 to 12 dollars a day on an AT&T or Verizon day pass, so roughly 70 to 84 dollars for a week. AT&T caps its Day Pass at 10 daily fees per line per bill period, so about 120 dollars covers the rest of that bill period on land, which matters on a trip longer than 10 days. T-Mobile is worth checking first, since its current mid and upper tiers include 5GB to 30GB of high-speed data abroad before slowing to 256kbps. Never roam with no plan, since pay-per-use runs about 2 dollars a megabyte, which is bill-shock territory." },
