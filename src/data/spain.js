  ...
  spokes: [
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in Spain: la propina, and what you owe",
      description: "Spanish tipping is modest. Whether a service charge appears at all, and how much to leave at restaurants, tapas bars and cafes. Checked 2026.",
      h1: "Tipping in Spain",
    ...
    },
    {
      ...
      topic: "pets",
      insurance: true,
      title: "Bringing a dog or cat to Spain from the US 2026",
      description: "Spain runs on the shared EU health-certificate process, with no quarantine and no titer. What is Spain-specific on arrival and after you settle in.",
    ...
    },
    {
      ...
      live: true,
      topic: "tourist-tax",
      title: "Spain tourist tax 2026: who charges, who does not",
      description: "Spain has no national tourist tax. Only Catalonia, with a Barcelona surcharge, and the Balearics charge one; Madrid, Andalucia and Valencia do not.",
    ...
    },
    {
      ...
      live: true,
      topic: "cash",
      title: "Do I need cash in Spain? Cards vs euros 2026",
      description: "Spain is card-first, so tap almost everywhere and keep a chip-and-PIN backup. Some tapas bars set a card minimum, and skip the Euronet ATMs.",
    ...
    },
    {
      ...
      topic: "connectivity",
      caution: "low",
      title: "eSIM for Spain: the cost math, and interior gaps",
      description: "Coverage is excellent in Spanish cities and on the coast, so this is a cost question. US roaming runs 10 to 12 dollars a day; an eSIM is far less.",
      ...
      faqs: [
        { q: "Do I need an eSIM for Spain?", a: "For most US travelers it is the cheapest way to get real data. Spain's coverage is strong in cities and along the coast, so it is a cost question: a Nomad eSIM is a few dollars per gigabyte, versus about 10 to 12 dollars a day for an AT&T or Verizon roaming pass. Set it up before you fly and it works from landing." },
        { q: "How much does it cost to use my US phone in Spain?", a: "About 10 to 12 dollars a day on an AT&T or Verizon day pass, so roughly 70 to 84 dollars a week. AT&T caps its Day Pass at 10 daily fees per line per bill period, so about 120 dollars covers the rest of that bill period on land, which matters on a trip longer than 10 days. T-Mobile is worth checking first, since its current mid and upper tiers include 5GB to 30GB of high-speed data abroad before slowing to 256kbps. Never roam with no plan, since pay-per-use runs about 2 dollars a megabyte." },
    ...
    },
    {
      ...
      topic: "driving",
      carExcess: true,
      title: "Renting a car in Spain: the fuel-policy trick, IDP",
      description: "Budget rentals in Spain push a full-to-empty fuel trick that overcharges you, you legally need an International Driving Permit, and excess cover is pricey.",
    ...
    },
    {
      ...
      topic: "taxis",
      caution: "low",
      title: "Spain taxi apps: Barcelona catch, Madrid flat fare",
      description: "Uber, Cabify and Bolt work in Madrid, but Barcelona's VTC law means pre-booking hours ahead, so hail a street taxi. Madrid airport is a fixed 33 euros.",
    ...
    },
    {
      ...
      topic: "scams",
      caution: "medium",
      title: "Common money scams in Spain, and what they cost",
      description: "The dollar-conversion push on card terminals, non-bank ATM fees, padded bills in tourist zones, and the distraction setups in Barcelona and Madrid.",
