...
export default {
  ...
  spokes: [
    ...
    },
    {
      ...
      description: `Coverage is excellent in Spanish cities and on the coast, so this is a cost question. US roaming runs ${S.dayPass}; an eSIM is far less.`,
      ...
      faqs: [
        { q: "Do I need an eSIM for Spain?", a: `For most US travelers it is the cheapest way to get real data. Spain's coverage is strong in cities and along the coast, so it is a cost question: a Nomad eSIM is a few dollars per gigabyte, versus about ${S.dayPass} for an AT&T or Verizon roaming pass. Set it up before you fly and it works from landing.` },
