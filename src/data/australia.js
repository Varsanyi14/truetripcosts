...
,
  ...
  spokes: [
    ...
    },
    {
      ...
      faqs: [
        { q: "Is an eSIM cheaper than roaming in Australia?", a: "Usually by a wide margin, though the gap stops growing sooner than you might think. A Nomad eSIM is a few dollars per gigabyte, against about 10 to 12 dollars a day for an AT&T or Verizon roaming pass, so a two-week trip runs about 120 dollars on AT&T, which caps its Day Pass at 10 daily fees per line per bill period. An eSIM still costs a fraction of that, and past day 10 on AT&T the daily arithmetic no longer applies." },
