export default {
  ...
  spokes: [
    ...
    },
    {
      ...
      description: "Moving to Greece with a pet from the US: why it runs on the shared EU health-certificate process, no quarantine and no titer, plus what is specific to Greece on arrival and after you settle in. Checked July 2026.",
