export default {
  ...
  spokes: [
    {
      ...
      live: true,
      topic: "visas",
      title: "Do US citizens need a visa for the Bahamas? 2026",
      description: "No visa and no advance form for US citizens. The passport rule that differs by flight or cruise, the onward-ticket rule, and Nassau pre-clearance.",
    ...
    },
    {
      ...
      live: true,
      topic: "cash",
      title: "Cash or card in the Bahamas: US dollars at par",
      description: "The Bahamian dollar is pegged 1 to 1, so US dollars spend at par with nothing to exchange. Where cards work, why the Out Islands need cash, ATM fees.",
      ...
      sections: [
        ...
        },
        {
          ...
          p: [
            ...
            "Read the hotel bill too. Around <b>Nassau, Paradise Island and Cable Beach</b>, area levies stack on top of the VAT and take the government side to roughly <b>21%</b>, and most resorts then add a <b>resort fee</b>, with some charging a mandatory gratuity <b>per person per night</b>. The advertised nightly rate is rarely the final number: see <a href='/bahamas/hotel-taxes-and-fees'>hotel taxes and fees</a> for the full stack. Your air departure tax of about 15 dollars is normally already inside your airfare.",
    ...
    },
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in the Bahamas: how much to tip 2026",
      description: "Tipping follows US habits at 15 to 20%, but check the bill first because resorts often add about 15% for you. Taxis, bars and housekeeping too.",
    ...
    },
    {
      ...
      live: true,
      topic: "taxis",
      title: "Nassau taxis: no Uber, and the fares to expect",
      description: "There is no Uber or Lyft in the Bahamas, and taxis use government zone fares, not meters, so agree the price first. Routes, jitneys and the water taxi.",
  ...
  tax: {
    ...
    currency: "BSD",
    capNights: null,
    note: "There is no per-person nightly bed tax in the Bahamas. The accommodation charges are percentages of the room instead: a 10% VAT everywhere, and around Nassau, Paradise Island and Cable Beach one or more area levies on top of it, which with the VAT charged on them takes the government side to roughly 21%. Pick the band that matches where you are staying. This does not include the resort fee or, at some resorts, a mandatory gratuity charged per person per night, both set by the property and neither modelled here. Stays of 45 continuous days or more are VAT exempt. Your air departure tax of about 15 dollars is almost always built into your airfare, and as a visitor you can claim the 10% VAT back on shopping through the Global Blue scheme.",
    regions: [
      { key: "nassau", label: "Nassau, Paradise Island or Cable Beach", pct: 21, note: "The 10% VAT plus the area levies charged by the promotion board and resort associations, which together with the VAT applied to them come to roughly 21%. Properties itemise these differently, so we give the total rather than a breakdown. A resort fee, and at some resorts a per-person nightly gratuity, sit on top of this and are not included." },
      { key: "outislands", label: "The Out Islands (Exuma, Eleuthera, Abaco and beyond)", pct: 10, note: "The 10% VAT, without the Nassau and Paradise Island area levies, so the government side is simpler here. A property may still add a resort fee of its own, which is not a tax and is not included." }
    ]
  },
  ...
  faqs: [
    ...
    { q: "Do I have to pay a tourist tax or departure tax in the Bahamas?", a: "There is no per-person nightly bed tax to hand over. On a hotel room you pay the 10% VAT, and around Nassau, Paradise Island and Cable Beach area levies take the government side to roughly 21%. Hotels then add a resort fee of their own, and some resorts a mandatory gratuity charged per person per night, so read the final bill. Your air departure tax of about 15 dollars is almost always built into your airfare, so you should not owe it separately at the airport, though cruise passengers pay separate taxes and tourism levies by sea." },
