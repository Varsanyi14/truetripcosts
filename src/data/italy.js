export default {
  ...
  spokes: [
    ...
    },
    {
      ...
      faqs: [
        { q: "Do I need an eSIM for Italy?", a: "For most US travelers it is the cheapest way to get real data. Italy's coverage is strong in cities and along the coast, so it is a cost question: a Nomad eSIM is a few dollars per gigabyte, versus about 10 to 10 to 12 dollars a day for an AT&T or Verizon roaming pass. Set it up before you fly and it works from landing." },
