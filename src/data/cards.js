...
export const cards = [
  ...
  { issuer: "Charles Schwab", product: "Investor Checking debit", network: "Visa", fxPct: 0, kind: "debit", atm: "Refunds ATM fees worldwide, with no limit", note: "Schwab refunds worldwide ATM fees with no cap, the standout for pulling cash abroad. Opening it also opens a linked Schwab brokerage account, though you never have to fund or invest it.", color: "#00A3E0", affiliate: free },
