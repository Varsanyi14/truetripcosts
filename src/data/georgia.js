  ...
  spokes: [
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in Georgia: how much and when 2026",
      description: "Tipping in Georgia is light and still emerging: about 10% in Tbilisi tourist restaurants, and a service charge to check for first. Checked 2026.",
    ...
    },
    {
      ...
      live: true,
      topic: "visas",
      title: "Georgia visa and the new 2026 insurance rule",
      description: "No visa for US citizens and a stay of up to 365 days, but from January 2026 all tourists must carry travel insurance of at least 30,000 GEL to enter.",
    ...
    },
    {
      ...
      live: true,
      topic: "cash",
      title: "Do I need cash in Georgia? Cards vs lari 2026",
      description: "Georgia is card-first in Tbilisi, Batumi and Kutaisi. Keep lari for markets, bakeries, tips and marshrutka minibuses, and choose lari at the terminal.",
    ...
    },
    {
      ...
      topic: "taxis",
      caution: "medium",
      title: "Taxis in Georgia: Bolt, Yandex and street cabs",
      description: "Bolt is the go-to app in Tbilisi and Batumi, cheap and fair. Agree the fare with street taxis, since older cabs have no meter, and marshrutkas are cash.",
    ...
    },
    {
      ...
      sections: [
        {
          ...
          p: [
            ...
            `The comparison with the alternatives is lopsided: a week of <b>AT&amp;T or Verizon</b> day passes is <b>${S.week}</b>, and a travel eSIM is a few dollars per gigabyte, so several times the local pack for less data. We earn a commission on eSIMs and nothing on a Magti SIM, and for a week in Georgia the SIM is the right buy.`
          ]
        },
        {
        ...
        },
        {
          ...
          icon: "roamfee",
          key: { fig: `${S.dayPassFig}`, tag: "Roaming default", text: "Georgia is on AT&T's covered-destination list, so the day pass applies, capped at 10 fees a bill period. Check T-Mobile before buying anything.", tone: "teal" },
          p: [
      ...
      faqs: [
        ...
        { q: "How much does it cost to use my US phone in Georgia?", a: `About ${S.dayPass} on an AT&T or Verizon day pass, and Georgia is on AT&T's covered-destination list so the day pass applies rather than pay-per-use. AT&T caps its Day Pass at ${S.capFees}, so about ${S.capAmount} covers the rest of that bill period on land, while Verizon's TravelPass has ${S.verizonNoCap} and keeps billing daily. T-Mobile is worth checking first.` }
      ],
        sources: {
        links: [
