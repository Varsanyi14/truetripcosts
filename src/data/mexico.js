export default {
  ...
  sources: {
    changed: "Aug 2026: added the two charges that actually sit on a Mexican hotel room and that this guide had never stated to a reader, the 16% federal IVA and the state lodging tax (ISH, typically 2 to 5%, and 5% in Quintana Roo). The IVA had appeared only in this change log, and the ISH was described as a small tax a few hotels add, which understated a charge that is statewide and mandatory in the tourist states. The tourist-tax calculator now models these on the room rather than only the per-night environmental charge and the one-time visitor fees. Earlier: sources added, and an update. Confirmed VISITAX in Quintana Roo (Cancun, Tulum, Cozumel and the Riviera Maya) is about 283 pesos, roughly 16 dollars, per person, paid online at visitax.gob.mx and now scanned at airport departure, with a 2026 proposal to fold it into hotel bills rejected. Added two places the guide had not covered: Baja California Sur (Los Cabos, La Paz, Loreto) charges a one-time 'Embrace It' visitor fee of about 28 dollars per person, and Puerto Vallarta began its own foreign-visitor fee in 2026. Confirmed the 16% IVA and the small per-room environmental tax. The peso figure, about 17.5 to the dollar, is current.",
    links: [
      { label: "VISITAX: official Quintana Roo state tourism tax portal", url: "https://www.visitax.gob.mx/sitio/", type: "gov" },
      { label: "SATQ (Quintana Roo tax authority): the state lodging tax law, the Ley del Impuesto al Hospedaje", url: "https://satq.qroo.gob.mx/contenidos/dmarcolegal/e821150a-eda1-11f0-8e6b-005056a29996", type: "revenue" },
    ...
    judgment: "The 16% IVA is federal and certain. The state lodging tax (ISH) is set state by state and several states changed it for 2026, so we give the 2 to 5% band rather than a per-state table. Quintana Roo at 5%, and 6% through digital platforms, traces to the reform of Article 8 of that state's lodging tax law effective 1 April 2023 and is consistent across several Mexican accounting practices; note that some online rate calculators still print 4% or 3% for Quintana Roo and we believe those are stale, so do not correct our figure down without checking the state law itself. For Baja California Sur we could not confirm a current ISH rate, so the calculator models the 16% IVA there as a floor rather than guessing. The Quintana Roo environmental charge of about 76 pesos per room per night is carried from our earlier check and one secondary source now quotes 30 pesos for a similarly named charge, which we have not been able to reconcile, so treat that figure as approximate. The daily cash share, tipping norms, and likely ATM behavior are our own estimate from experience, not an official figure.",
  },
  ...
  tax: {
    ...
    regions: [
      { key: "qroo", label: "Cancun, Riviera Maya, Tulum, Cozumel (Quintana Roo)", unit: "percentOfRoom", pct: 21, oneTimePerPerson: 283, taxLabel: "Quintana Roo hotel taxes", note: "The 16% federal IVA plus Quintana Roo's 5% state lodging tax (ISH), about 21% on the room, and a one-time VISITAX of about 16 dollars per person for the whole trip, easiest paid online before you travel. Booked through a digital platform the state rate is 6% rather than 5%. This assumes your quoted rate excludes tax; if it said impuestos incluidos, this percentage is already in it. On top of this, Quintana Roo hotels add an environmental charge of about 76 pesos, roughly 4 dollars, per room per night, which is not modelled here, so add that separately." },
      { key: "bcs", label: "Los Cabos, La Paz, Loreto (Baja California Sur)", unit: "percentOfRoom", pct: 16, oneTimePerPerson: 488, taxLabel: "Baja California Sur hotel taxes", note: "The 16% federal IVA, plus a one-time 'Embrace It' visitor fee of about 28 dollars per person (ages 12 and up, staying over 24 hours), paid online with a QR code and checked at the airport. Baja California Sur also charges a state lodging tax (ISH) and Los Cabos hotels a small nightly sanitation fee, neither modelled here because we could not confirm the current rates, so treat the 16% as the floor and ask your hotel. This assumes your quoted rate excludes tax; if it said impuestos incluidos, the 16% is already in it." },
      { key: "other", label: "Elsewhere in Mexico", unit: "percentOfRoom", pct: 16, taxLabel: "Mexico hotel taxes", note: "The 16% federal IVA, which applies to lodging everywhere. Your state will add its own lodging tax (ISH) on top, typically 2 to 5%, set state by state and changed in several states for 2026, so check the tax breakdown on your booking. Most of Mexico has no separate visitor fee beyond that. This assumes your quoted rate excludes tax; if it said impuestos incluidos, the 16% is already in it." }
    ]
  },
  ...
  spokes: [
    {
      ...
      title: "Mexico roaming: you may already be covered 2026",
      description: "Most US plans already include Mexico, so many travelers should buy nothing. Which plans leave you exposed, and why the cheapest eSIM can miss your area.",
    ...
    },
    {
      ...
      live: true,
      topic: "visas",
      title: "Mexico FMM tourist card and Visitax explained",
      description: "If you fly, the FMM tourist card is already paid inside your airfare. The one fee on you is Visitax, only in Quintana Roo, about $15 to $17 online.",
      ...
      sections: [
        ...
        },
        {
          ...
          p: [
            ...
            "Separately from all of the above, a hotel room carries the <b>16% federal IVA</b> and a <b>state lodging tax</b> of typically <b>2 to 5%</b>, which is <b>5% in Quintana Roo</b>. These are taxes on the room rather than entry charges, they are commonly about a fifth on top, and they may or may not be inside the rate you were quoted. Some Quintana Roo hotels also add an environmental charge of roughly 4 dollars per room per night at the desk. For per-night levies and entry fees across countries see <a href=\"/tourist-taxes\">tourist taxes and entry fees</a>, for what lands on an accommodation bill see <a href=\"/hotel-taxes-and-fees\">hotel taxes and fees</a>, and for cards, cash and ATMs, the <a href=\"/mexico\">Mexico money guide</a>."
          ]
        }
      ],
      faqs: [
    ...
    },
    {
      ...
      live: true,
      topic: "cash",
      title: "Do I need cash in Mexico? Cards vs pesos 2026",
      description: "Cards work at hotels, resorts and city restaurants, but you need pesos for taxis, street food and tips. Always pay in pesos, and decline ATM dollars.",
    ...
    },
    {
      ...
      topic: "taxis",
      caution: "medium",
      title: "Uber or DiDi in Mexico? The Cancun airport catch",
      description: "Uber, DiDi and inDrive all work in Mexico. Why Mexico City airport rules keep changing, and why you cannot count on an app from Cancun airport.",
    ...
    },
    {
      ...
      topic: "pets",
      insurance: true,
      title: "Bringing a dog or cat to Mexico: easy in, then home",
      description: "Entry is one of the simplest anywhere: no health certificate, a quick SENASICA look. The real paperwork is the return leg for dogs, thanks to screwworm.",
    ...
    },
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in Mexico: how much, and the resort trap",
      description: "The restaurant standard is 10 to 15%, and cash in pesos is best. How much for hotel staff and drivers, and the resort double-tip trap to watch for.",
    ...
    },
    {
      ...
      live: true,
      topic: "driving",
      title: "Renting a car in Mexico: the insurance trap 2026",
      description: "The rate you booked is not the real price: Mexican law requires local liability your US card does not cover, and it is left out of the quote. Plus tolls.",
    ...
    },
    {
      ...
      live: true,
      topic: "seasons",
      title: "When is Mexico cheapest? A 2026 cost calendar",
      description: "Prices swing 30 to 50 percent by season. High season is mid-December to April, spikes are Christmas, spring break and Semana Santa, cheapest is September.",
    ...
    },
    {
      ...
      live: true,
      topic: "all-inclusive",
      title: "Mexico all-inclusive: the extras not included 2026",
      description: "Specialty restaurants at $25 to $80, premium drinks, spa, water sports, excursions, transfers and a per-night eco tax at the desk all cost extra.",
    ...
    },
    {
      ...
      live: true,
      topic: "scams",
      title: "Common money scams in Mexico, and what they cost",
      description: "Taxi overcharges, the pay-in-dollars card trick, ATM skimming, padded bar bills, roadside police fines and timeshare pressure. How to sidestep each.",
