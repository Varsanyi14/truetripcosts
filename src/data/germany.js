  ...
  spokes: [
    {
      ...
      topic: "taxis",
      caution: "low",
      title: "Taxis in Germany: FreeNow, and honest meters 2026",
      description: "FreeNow leads in Germany, with Uber and Bolt. Taxis are metered and regulated, the S-Bahn often beats a cab from the airport, and tips stay modest.",
    ...
    },
    {
      ...
      live: true,
      topic: "cash",
      title: "Do I need cash in Germany? More than you think",
      description: "Germany takes cards in bigger shops but still runs on cash in bakeries, bars, kiosks and many restaurants. Carry euros, choose euros, skip Euronet ATMs.",
    ...
    },
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in Germany: Trinkgeld, and how to leave it",
      description: "German Trinkgeld is modest, and you tell the server the total rather than leaving coins on the table. How much to leave. Checked 2026.",
    ...
    },
    {
      ...
      topic: "pets",
      insurance: true,
      title: "Bringing a dog or cat to Germany from the US 2026",
      description: "Germany runs on the shared EU health-certificate process, with no quarantine and no titer. What is Germany-specific on arrival and when you register.",
    ...
    },
    {
      ...
      topic: "driving",
      caution: "medium",
      title: "Driving in Germany: no toll, but the Umweltzone",
      description: "There is no motorway toll for cars in Germany, but the green Umweltzone sticker is the trap that catches tourists. How rental fines reach you later.",
    ...
    },
    {
      ...
      topic: "connectivity",
      caution: "low",
      title: "eSIM for Germany: the cost math, and train gaps",
      description: `Coverage is strong almost everywhere in Germany, so this is a cost question. US roaming runs ${S.dayPass}; an eSIM is a few per gigabyte.`,
      ...
      answer: `Coverage is <b>strong across Germany</b>, small towns included, so this is mostly a cost question. Your US carrier charges about <b>${S.dayPass}</b> to roam (<b>AT&amp;T and Verizon</b> day passes), and <b>T-Mobile</b> is worth checking before you buy anything, because its current mid and upper tiers include a real <b>high-speed allowance</b> abroad, from <b>5GB up to 30GB</b> depending on plan, and only slow to <b>${S.throttle}</b> after that. A <b>Nomad eSIM</b> is a few dollars per gigabyte, activates before you fly and works on landing, so for a data-first trip it is the cheaper option. If you are travelling rurally or by <b>ICE train</b>, favour an eSIM that rides <b>Deutsche Telekom</b>, which has the most consistent reach. Never roam <b>pay-per-use</b>, which runs about ${S.ppu}.`,
      sections: [
        {
          h: "A cost question first",
          icon: "roamfee",
          key: { fig: `${S.dayPassFig}`, tag: "Roaming default", text: `Coverage is good almost everywhere, so this is mainly about cost. A US carrier day pass runs about ${S.dayPassGlance}, and T-Mobile is the exception, with ${S.tmoRange} of high-speed data abroad on its current mid and upper tiers, so check yours before buying.`, tone: "teal" },
          p: [
            `Germany's networks are good in the places you will be, so the decision is how you pay. The expensive default is roaming on your US plan: <b>AT&amp;T and Verizon</b> charge about <b>${S.dayPass}</b>, so a week runs <b>${S.week}</b> and a two-week trip is most of a nice dinner in Munich. <b>T-Mobile</b> is the exception worth checking first: its current tiers include a genuine <b>high-speed allowance</b> abroad, roughly <b>${S.tmoLow}</b> on Experience More, Magenta MAX and Go5G Plus, <b>${S.tmoMid}</b> on Experience Beyond and Go5G Next, and <b>${S.tmoHigh}</b> on Better Value, slowing to <b>${S.throttle}</b> only once that is used up. The entry <b>Essentials</b> tier is the one throttled from the start. Google Fi and Visible set their own terms, so read your own plan rather than assuming.`,
            `Whatever you choose, do not roam with <b>no plan at all</b>. Pay-per-use data runs around <b>${S.ppu}</b>, which is thousands per gigabyte, and phones quietly use data in the background, so <b>turn off data roaming</b> until an eSIM or a day pass is active.`
          ]
        },
        {
