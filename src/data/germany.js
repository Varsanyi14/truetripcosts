export default {
  ...
  spokes: [
    ...
    },
    {
      ...
      description: "Coverage is strong almost everywhere in Germany, so this is a cost question. US roaming runs 10 to 12 dollars a day; an eSIM is a few per gigabyte.",
      ...
      faqs: [
        { q: "Is an eSIM cheaper than roaming in Germany?", a: "For most US travelers, yes. A Nomad eSIM is a few dollars per gigabyte, against about 10 to 12 dollars a day for an AT&T or Verizon roaming pass, so a week of roaming costs roughly 70 to 84 dollars where an eSIM with a sensible data allowance costs a fraction of that. Set it up before you fly and it works from landing." },
