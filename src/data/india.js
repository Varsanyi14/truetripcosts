  ...
  spokes: [
    {
      ...
      live: true,
      topic: "cash",
      title: "Do I need cash in India? Yes, carry rupees 2026",
      description: "Cards work at hotels and nicer restaurants, but markets, street food, autos and small shops run on cash. Locals use UPI, which is hard for visitors.",
    ...
    },
    {
      ...
      live: true,
      topic: "tipping",
      title: "Tipping in India: baksheesh, and how much 2026",
      description: "Baksheesh means small tips, given often. About 10% at restaurants, the service charge to check for first, and who else expects one. Checked 2026.",
      h1: "Tipping in India",
    ...
    },
    {
      ...
      live: true,
      topic: "visas",
      title: "India e-visa for US citizens: how to apply 2026",
      description: "US citizens need an e-Tourist Visa, applied for online before you fly. The official portal, fees from about $25, and the 30-day, 1-year and 5-year options.",
    ...
    },
    {
      ...
      topic: "taxis",
      caution: "medium",
      title: "India taxi apps, and the airport tout trap 2026",
      description: "Uber, Ola and bike-taxi Rapido cover India. How airport touts and prepaid scams work, why the Delhi Airport Express is calmer, and the note-switch trick.",
    ...
    },
    {
      ...
      live: true,
      topic: "scams",
      title: "Common money scams in India, and what they cost",
      description: "Auto-rickshaw and taxi overcharging, the your-hotel-is-closed commission scam, gem and carpet export scams, and fake tourist offices. How to sidestep them.",
      ...
      sections: [
        {
          ...
          p: [
            `A prepaid plan from <b>Jio</b> or <b>Airtel</b>, India's two strongest networks, costs about <b>300 rupees</b>, near <b>4 dollars</b>, and carries <b>1.5GB to 2GB a day for 28 days</b> along with unlimited local calls. Put that beside the alternatives and the gap is not a rounding error: a week of <b>AT&amp;T or Verizon</b> day passes is <b>${S.week}</b>, and a travel eSIM with a sensible allowance is a few dollars per gigabyte. The local SIM undercuts both by a wide margin, and we earn nothing when you buy one.`,
            `So the recommendation on this page is a local SIM for anyone staying more than a couple of days, and the reason is arithmetic rather than preference. <b>Airtel</b> has the better reach in the hills and the northeast, <b>Jio</b> has the widest 5G and usually the larger daily allowance, and in the cities either is fine. What you should not do is roam with <b>no plan</b>: pay-per-use runs about <b>${S.ppu}</b>, thousands per gigabyte, and background app activity alone will find it, so <b>turn off data roaming</b> until something is active.`
          ]
        },
        {
        ...
        },
        {
          ...
          icon: "roamfee",
          key: { fig: `${S.dayPassFig}`, tag: "Roaming default", text: `T-Mobile is the exception worth checking before you buy anything, with ${S.tmoRange} of high-speed data abroad on its mid and upper tiers.`, tone: "teal" },
          p: [
            `The expensive default is roaming on your US plan: <b>AT&amp;T and Verizon</b> day passes run about <b>${S.dayPass}</b>, so a week is roughly <b>${S.week}</b>. <b>T-Mobile</b> is the exception worth checking first, because its current tiers include a genuine <b>high-speed allowance</b> abroad, roughly <b>${S.tmoLow}</b> on Experience More, Magenta MAX and Go5G Plus, <b>${S.tmoMid}</b> on Experience Beyond and Go5G Next and <b>${S.tmoHigh}</b> on Better Value, slowing to <b>${S.throttle}</b> only once that is used up. The entry <b>Essentials</b> tier is throttled from the start. Google Fi and Visible set their own terms, so read your own plan rather than assuming.`,
